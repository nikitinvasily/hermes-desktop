...
The base dark/light themes use the "Azure" palette (user-selected 2026-09-19): dark accent `#4c9ffe` with user bubble `#2d6fd0`, light accent `#0b6bcb` with user bubble `#0a5cb0` — the previous `#003f7a` navy read 1.53:1 against the dark background (below any WCAG threshold); Azure passes AA for text-bearing surfaces in both appearances.
