...
Row titles render at 13px (one step up from the 12px chrome text), and the working-chat spinner uses the bullet's neutral muted color — no accent tint anywhere in the row.
